...
package com.eziosoft.mqtt_test.ui.customViews;
...
public class JoystickView extends View implements Runnable {
    ...
    */
    ...
    private boolean squareBehaviour = false;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        // Draw the button as simple circle
            ...
            canvas.drawLine(mPosX + mFixedCenterX - mCenterX, mPosY + mFixedCenterY - mCenterY, mFixedCenterX, mFixedCenterY, mPaintCircleBorder);
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        if (!squareBehaviour) {
            ...
            if (mPosX > mCenterX + mBorderRadius)
                mPosX = mCenterX + mBorderRadius;
            if (mPosX < mCenterX - mBorderRadius)
                mPosX = mCenterX - mBorderRadius;

            if (mPosY > mCenterY + mBorderRadius)
    ...
    private float lastSetX, lastSetY;

    public void setPosition(float x, float y) {
        lastSetX = x;
        lastSetY = y;
        mPosX = (int) (mCenterX + x * mBorderRadius);
        mPosY = (int) (mCenterY + y * mBorderRadius);
    ...
    public boolean isSquareBehaviour() {
        return squareBehaviour;
    }

    public void setSquareBehaviour(boolean squareBehaviour) {
